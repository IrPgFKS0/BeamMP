...
**Current release: `BeamMP-LAN-p13h61.zip`** (mod `4.22.0-LAN p13h61`, combined host exe `p13h35`, **for BeamNG 0.39**,
Windows + Linux x86-64).

| File | sha256 |
|---|---|
| `BeamMP-LAN-p13h61.zip` | `35899644C593C619B06250B1EB1A2C2AC3E6EDBA11138919D9FC0ED673E6D08C` |
...
[BeamMP-Server](https://github.com/IrPgFKS0/BeamMP-Server)) at tag `lan-release-p13h61`
