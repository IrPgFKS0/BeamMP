...
const LEGACY_LOGO_PATH = "/ui/assets/BeamMP/beammp_new_cropped.png" // LAN: MUST be absolute -- the Vue app's base is /ui/entrypoints/main/, so upstream's relative path 404s every render (their #926 slip; every sibling asset ref is absolute)
