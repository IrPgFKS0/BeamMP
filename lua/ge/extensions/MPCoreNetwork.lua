...
local modVersion = "4.22.1-LAN p13h91" -- POLICY: the base (4.22.1) tracks the upstream BeamMP mod version we are
-- synced against (upstream aaad6e7c / tag v4.22.1, their 0.39 release); bump it whenever an upstream sync lands so
