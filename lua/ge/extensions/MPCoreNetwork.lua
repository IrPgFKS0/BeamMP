...
local modVersion = "4.22.1-LAN p13h90" -- POLICY: the base (4.22.0) tracks the upstream BeamMP mod version we are
-- synced against (upstream a97f338e / tag v4.22.0, their 0.39 release); bump it whenever an upstream sync lands so
